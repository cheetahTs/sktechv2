...
require_once __DIR__ . '/credenciales.php';
 ...
 if(isset($_SESSION['nombreusuario'])){
   ...
   $sentencia2 = $conexion ->
 query("SELECT * FROM supu WHERE operadorN='$nombreUsuario'AND tipoOp_Sup='op';");
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <li class="nav-item">
        <a class="nav-link" href="tablaHtm.php">Administrar Listado</a>
      </li>
       ...
       <thead class="thead-dark">
         ...
         <th style="width:15%;">U-D</th>
                 ...
                 while($datos=$sql->fetch_object()){ ?>
                        ...
                        <td>
                            <a style="padding:1%" href="UpdateOp.php?numeroOp=<?= $datos->numeroOp ?>" class="btn btn-small btn-warning"><i class="fa-solid fa-pen-to-square"> Edit</i></a>
