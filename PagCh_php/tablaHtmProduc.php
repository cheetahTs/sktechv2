      ...
      <table class="table table-striped">  <tbody>
       <thead class="thead-dark">
         ...
         <th style="width:15%;">U-D</th>
                 ...
                 $sql=$conexion->query("select * from products ORDER BY id_prod DESC");
                 while($datos=$sql->fetch_object()){ ?>
                        ...
                        <td>
                            <a style="padding:1%" href="http://localhost/paginachota2/UpdateProduct.php?id_prod=<?= $datos->id_prod ?>" class="btn btn-small btn-warning"><i class="fa-solid fa-pen-to-square"> Edit</i></a>
                            <a style="padding:1%" href="deleteProd.php?id_prod=<?= $datos->id_prod ?>" class="btn btn-small btn-danger"><i class="fa-solid fa-trash">Delete</i></a>
                        </td>
                    </tr>
